...
from pyspikex.websocket.spikex_websocket import SpikexWebsocketClient


class PerpWebsocketStreamClient(SpikexWebsocketClient):
    def __init__(
            self,
            stream_url="wss://fstream.spikex.com",
            on_message=None,
            on_open=None,
            on_close=None,
            on_error=None,
