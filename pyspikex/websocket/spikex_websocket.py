...
class SpikexSocketManager(threading.Thread):
    def __init__(
            self,
            stream_url,
            on_message=None,
    ...
    def send_message(self, message):
        logger.debug(f"Sending message to Spikex.com WebSocket Server: {message}")
...
class SpikexWebsocketClient:
    ...
    def __init__(
        ...
        logger.debug("Spikex.com WebSocket Client started.")
    ...
    def ping(self):
        logger.debug("Sending ping to Spikex.com WebSocket Server")
